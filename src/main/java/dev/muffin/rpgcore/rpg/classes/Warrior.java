...
public class Warrior extends RPGClass {
    public Warrior(List<Skill> warriorSkills, List<Skill> warriorModifiedSkills, List<Skill> passiveSkills, List<Skill> modifiedPassiveSkills) {
        super(WARRIOR_NAME,
                ...
                warriorSkills, warriorModifiedSkills, passiveSkills, modifiedPassiveSkills);
    }
}
